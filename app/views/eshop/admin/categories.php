			                          ...
			                          <div class="form-group">
			                              ...
			                              <div class="col-sm-10">
			                                  <select id="parent" name="parent"  class="form-control" required>
               	  	  					...
               	  	  					<button type="button" class="btn btn-danger" onclick="show_add_new(event)" style="position:absolute;bottom:10px; left:10px;">Close</button>
              	  	  					<button type="button" class="btn btn-success" onclick="collect_data(event)" style="position:absolute;bottom:10px; right:10px;">Save</button>
			                      ...
			                      <form class="form-horizontal style-form" method="post">
			                          ...
			                          <div class="form-group">
			                              ...
			                              <div class="col-sm-10">
              	  	  					...
              	  	  					<button type="button" class="btn btn-danger" onclick="show_edit_category(0,'',event)" style="position:absolute;bottom:10px; left:10px;">Cancel</button>
              	  	  					<button type="button" class="btn btn-success" onclick="collect_edit_data(event)" style="position:absolute;bottom:10px; right:10px;">Save</button>
